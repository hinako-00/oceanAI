...
export const THEME_KEYS = ['navy', 'ocean', 'sky'] as const;
...
export interface ThemeOption {
  ...
  name: string;
  description: string;
  /** 配色の性格を一目で伝える見本の色。globals.css の light 側と揃える。 */
...
export const THEME_OPTIONS: ThemeOption[] = [
  {
    ...
    name: 'ディープネイビー',
    description:
      '濃紺と、はっきりした罫線。一覧や表を数多く読むときに文字が拾いやすい既定の配色です。',
    swatch: ['#123a75', '#dde7f5', '#e9eef5', '#0b1626'],
  },
  {
    key: 'ocean',
    name: 'オーシャンブルー',
    description: '白地に澄んだ青。文字と背景の差が一番大きく、明るい場所でも読めます。',
    swatch: ['#1a5fd0', '#e3ecfd', '#f2f6fc', '#101f38'],
  },
  {
    key: 'sky',
    name: 'ソフトスカイ',
    description: '水色寄りのやわらかい青。角を大きく丸め、線を弱めています。長時間見る人向け。',
